...
class ScopeGroupTest extends TestCase
{
    ...
    {
        $this->assertCount(0, User::group('test-user-group')->get());
    }
    ...
    public function test_it_should_return_only_users_with_the_specified_group()
    {
        ...
        $this->assertCount(2, User::group('test-user-group')->get());
        $this->assertCount(1, User::group($this->testUserGroup2)->get());
    }
